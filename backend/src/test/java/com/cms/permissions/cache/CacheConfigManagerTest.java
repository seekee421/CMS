...
class CacheConfigManagerTest {
    ...
    void testCacheConfiguration() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String ttl = (String) redisTemplate.opsForValue().get("config:cache:ttl");
            String maxSize = (String) redisTemplate.opsForValue().get("config:cache:maxsize");
    ...
    void testCacheStats() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String evictions = (String) redisTemplate.opsForValue().get("stats:evictions");
    ...
    void testCacheCleanup() {
        ...
        assertDoesNotThrow(() -> {
            // Create test data
            for (int i = 0; i < 10; i++) {
                redisTemplate.opsForValue().set("cleanup:test:" + i, "value" + i);
            }
